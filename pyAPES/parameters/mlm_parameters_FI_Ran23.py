...
"""
## lai cycle params modified, increased laimax for decid and shrubs. plant h not increased from 22.  SS 5 june 26
import numpy as np
...
gpara = {'dt' : 1800.0,  # timestep in forcing data file [s]
        ...
        #  'end_time' : "2022-06-30",  # end time of simulation [yyyy-mm-dd]
         'start_time' : "2023-05-01",  # start time of simulation [yyyy-mm-dd]
         'end_time' : "2023-09-30",  # end time of simulation [yyyy-mm-dd]
