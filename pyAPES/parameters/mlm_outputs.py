...
output_variables = {'variables': [# variable name, description [units], (dimensions)
      ...
      ['pt_C_pool','size of carbon pool per ground area [umol C m-2]', ('date', 'simulation', 'planttype')],
      ['pt_d13c_C_pool','carbon pool d13C [permil]', ('date', 'simulation', 'planttype')],
      ['pt_d18o_C_pool','carbon pool d18O [permil]', ('date', 'simulation', 'planttype')],
      ['pt_d13c_treering_celluose','tree ring cellulose d13C [permil]', ('date', 'simulation', 'planttype')],
      ['pt_d18o_treering_celluose','tree ring cellulose d18O [permil]', ('date', 'simulation', 'planttype')],      
      ]
