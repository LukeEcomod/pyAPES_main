...
gpara = {
    ...
    'forc_filename' : r"Degero/Degero_forcing_2014-2016.dat",  # forcing data file*
...
# grid
grid = {
    'zmax': 5.0,  # heigth of grid from ground surface [m]
    'Nlayers': 21  # number of layers in grid [-]
}
...
pt2 = { 'name': 'pine',
        'LAImax': 0.1, # maximum annual LAI m2m-2
        'lad': lad_weibul(z, LAI=1.0, h=3.0, hb=0.5, species='pine'),  # leaf-area density m2m-3
        # cycle of photosynthetic activity
        'phenop': {
            'Xo': 0.0,
            'fmin': 0.1,
        ...
        'photop': {
            'Vcmax': 50.0,
            'Jmax': 98.0,  # 1.97*Vcmax (Kattge and Knorr, 2007)
            'Rd': 1.2,  # 0.023*Vcmax
            'tresp': { # temperature response parameters (Kattge and Knorr, 2007)
                'Vcmax': [78., 200., 649.],
                'Jmax': [56., 200., 646.],
...
Sphagnum = {
    ...
    'photosynthesis': { # farquhar-parameters
        ...
        'tresp': {
            'Vcmax': [69.83, 200.0, 649.],
            'Jmax': [100.28, 147.92,646.],
            'Rd': [33.0]
        }
    },
    ...
    'water_retention': {
        ...
        'saturated_conductivity': 1e-5, #2.88e-4,  # [m s-1], based on fitted value
...
soil_properties = {
   ...
   #    },
    'pF': {  # vanGenuchten water retention parameters
           'ThetaS': [0.945, 0.945, 0.945, 0.918, 0.918, 0.918, 0.918, 0.918, 0.918, 0.918, 0.918, 0.918],
           'ThetaR': [0.098, 0.098, 0.098, 0.098, 0.098, 0.098, 0.098, 0.098, 0.098, 0.098, 0.098, 0.098],
           'alpha': [0.338, 0.338, 0.338, 0.072, 0.072, 0.072, 0.072, 0.072, 0.072, 0.072, 0.072, 0.072],
...
water_model = {
    ...
    'initial_condition': {  # (dict) initial conditions
        'ground_water_level': -0.3,  # groundwater depth [m]
...
heat_model = {
    'solve': True,
    'initial_condition': {
        'temperature': [2.0 for i in range(N_dz)] 
        #[
