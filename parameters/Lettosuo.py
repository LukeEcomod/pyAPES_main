...
gpara = {'dt' : 1800.0,  # timestep in forcing data file [s]
           ...
           'end_time' : "2010-06-10",  # end time of simulation [yyyy-mm-dd]
           'forc_filename' : "Lettosuo/Lettosuo_forcing_2010_2018.csv",  # forcing data file*
           'results_directory':'results/Lettosuo/'
         }
...
pt1 = { 'name': 'pine',
        'LAImax': 1.92, # maximum annual LAI m2m-2
...
pt2 = { 'name': 'spruce',
        'LAImax': 1.62, # maximum annual LAI m2m-2
...
pt3 = { 'name': 'decid',
        'LAImax': 1.12, # maximum annual LAI m2m-2
