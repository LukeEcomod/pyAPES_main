...
cProfile.run("driver(parameters=params, create_ncf=True, result_file= 'testrun_fullsoil_profile_moss_iteration_hackathon_day3.nc')","lad_run_profile_long_fullsoil_moss_iteration_hackathon_day3.prof")

# run model
#outputfile, Model = driver(parameters=params, create_ncf=True, result_file= 'testrun_fullsoil_profile_moss_convergence_hackathon_day3.nc')
